...
type GoodsCommonAddUpdate struct {
	...
	Name             string `json:"name"             description:"商品名称" v:"required#名称必填"`
	Price            int    `json:"price"            description:"价格 单位分"  v:"required#价格必填"`
	...
	Brand            string `json:"brand"            description:"品牌" v:"max-length:30#品牌名称最大30字符"`
...
type GoodsUpdateReq struct {
	...
	Id     int `json:"id"      v:"min:1#请选择需要修改的商品" dc:"商品Id"`
	GoodsCommonAddUpdate
}
...
type GoodsGetListCommonReq struct {
	g.Meta `path:"/goods/list" method:"get" tags:"商品" summary:"查询商品列表"`
	CommonPaginationReq
}
